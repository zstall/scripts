...
# NOTE: in bash arrays, NO COMMAS. This will break the script. fields=( 'Title' 'Title Class' 'Rating' 'Release Date (Year)' 'Director' 'Characters (Primary)' 'Talent' 'Genres' 'Location:State' 'Location:Region' 'Location:Setting' 'Characters (Secondary)' 'Theme (Secondary)' 'House Number' 'Video Bitrate' 'Episode Sequence' 'Video Width' 'Audio Channels' 'Audio Tracks' 'Original Air Date' 'Video Height' 'Video Framerate' 'Audio Bit Depth' 'Audio Sample Rate' 'Telecine' 'Episode Run Order' 'Tech Details Last Updated' 'Bitrate' 'Synopsis Short' 'Audio Bitrate' 'Rightsline ID-Season' 'SIMS ID' 'Synopsis Long' 'FilmID' 'Start Timecode - Metadata' 'Rightsline ID-Series' 'EIDR Title' 'EIDR Series' 'Metabase Title Code' 'Caption Asset' 'Rightsline ID' 'Gracenote TMS ID' 'assetVersionsCount' 'Synopsis Medium' )
